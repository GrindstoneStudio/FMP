...
public class Player : MonoBehaviour
{
    ...
    public float turnSpeed = 15f; //The senitivty of the camera
    ...
    public float walkSpeed; //this is the speed that the player will move at
    public float jumpHeight; //this is the height the player can jump up to
    ...
    public int range; //The range that the player can interact wiht objects
    ...
    {
        rotX += Input.GetAxis("Mouse Y") * turnSpeed; //Input from mouse fore camera movement
        rotY += Input.GetAxis("Mouse X") * turnSpeed; //Input from mouse fore camera movement
